...
class ToyTopo(Topo):
    ...
    def build(self, **_opts):
        ...
        r1_IP_2 = '192.168.1.3/24'  # IP address for r1-eth1
        ...
        r2_IP_2 = '172.16.0.3/24'  # IP address for r1-eth1
        ...
        self.addLink(r1, r2, intfName1='r1-eth1', intfName2='r2-eth1',
                     params1={'ip': r1_IP_2}, params2={'ip': r2_IP_2})  # for clarity



        self.addLink(r1, s1, intfName1='r1-eth2', intfName2='s1-eth0',
                     params1={'ip': r1_IP_1})  # for clarity
        self.addLink(r2, s2, intfName1='r2-eth2', intfName2='s2-eth0',
                     params1={'ip': r2_IP_1})
        self.addLink(s2, s3, intfName1='s2-eth1', intfName2='s3-eth0')
        self.addLink(s2, s4, intfName1='s2-eth2', intfName2='s4-eth0')
        self.addLink(s3, s4, intfName1='s3-eth1', intfName2='s4-eth1')
        ...
        #unused
        h5 = self.addHost('h5', ip='172.16.0.103/12',
                          defaultRoute='via 20.0.0.1')
